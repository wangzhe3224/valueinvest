"""
Registry for market-specific cash flow data fetchers.
...
Usage:
    ...
    CashFlowRegistry.register_fetcher(Market.HK, HKCashFlowFetcher)
    
    # Get appropriate fetcher for ticker
    fetcher = CashFlowRegistry.get_fetcher("00700")
"""
...
class CashFlowRegistry:
    ...
    def get_fetcher(cls, ticker: str, **kwargs):
        ...
        if fetcher_class is None:
            raise ValueError(f"No cash flow fetcher registered for market: {market}")
    ...
    def _setup_defaults(cls) -> None:
        ...
        try:
            from .fetcher.yfinance_cashflow import YFinanceCashFlowFetcher

            cls.register_fetcher(Market.US, YFinanceCashFlowFetcher)
        except ImportError:
            pass

        # A-shares via akshare (future implementation)
        # try:
        #     from .fetcher.akshare_cashflow import AKShareCashFlowFetcher
        #     cls.register_fetcher(Market.A_SHARE, AKShareCashFlowFetcher)
        # except ImportError:
        #     pass
